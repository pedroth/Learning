...
public class Matrix {
    ...
    /**
     * @param v1 : dimension must be n x 1
     * @param v2 : dimension must be n x 1
     * @return
     */
    ...
    /**
     * @param xmin first element of the returning vector
     * @param step
     * @param xmax last element of the returning vector
    ...
    /**
     * @param v : is a matrix {number of lines} x 1;
     * @param n : number of column
     */
