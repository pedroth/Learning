...
public class LinearSystemError extends BinaryNode {
	...
	public LinearSystemError(FunctionNode[] args, double a11, double a21, double a12, double a22, double z1, double z2) {
		super(args);
		this.a11 = a11;
		this.a21 = a21;
		this.a12 = a12;
	...
	public LinearSystemError(double a11, double a21, double a12, double a22, double z1, double z2) {
		super();
		this.a11 = a11;
		this.a21 = a21;
		this.a12 = a12;
